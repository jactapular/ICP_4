# -*- coding: utf-8 -*-
"""
Created on Wed Feb 14 10:19:35 2018
...
tre = pd.read_csv('Under Tree.csv')
tre = clean(data = tre)
...
ax = tre.plot(color = 'b', x='Date Time', y= 'Temperature')
...
ax.legend(["Sand", "Concrete"])
plt.savefig('Compare_Sand_Concrete2.png', bbox_inches='tight')
